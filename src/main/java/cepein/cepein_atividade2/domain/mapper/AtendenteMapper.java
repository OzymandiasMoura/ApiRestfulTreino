...
public class AtendenteMapper
{
    ...
    {
        AtendenteDto dto = new AtendenteDto(entity.getIdAtendente(), entity.getNome(), entity.getCpf(), entity.getAtivo());
        return dto;
    }

    public static Atendente dtoToEntity(AtendenteDto dto)
    {
        Atendente entity = new Atendente(dto.getIdAtendente(), dto.getNome(), dto.getCpf(), dto.getAtivo());
        return entity;
    }
}
